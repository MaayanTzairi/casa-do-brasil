...
export default function Footer() {
  ...
  const socials = (
    <div style={{ display: "flex", gap: "0.4rem", justifyContent: "center" }}>
      <SocialBtn href="https://www.instagram.com/casadobrasilll/" label="Instagram" hoverColor="#E1306C">
        <svg width={14} height={14} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
          <rect x="2" y="2" width="20" height="20" rx="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/>
        </svg>
      </SocialBtn>
      <SocialBtn href="https://www.facebook.com/casadobrasil" label="Facebook" hoverColor="#1877F2">
        <svg width={14} height={14} viewBox="0 0 24 24" fill="currentColor">
          <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
        </svg>
      </SocialBtn>
      <SocialBtn href="https://www.tiktok.com/@casadobrasileilat" label="TikTok" hoverColor="#69C9D0">
        <svg width={14} height={14} viewBox="0 0 24 24" fill="currentColor">
