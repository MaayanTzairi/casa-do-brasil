        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "0.5rem", padding: "0 1.5rem" }}>
            <div style={{ display: "flex", alignItems: "baseline", gap: "2px" }}>
              <span style={{ fontFamily: "'Heebo', sans-serif", fontWeight: 900, fontSize: "clamp(38px, 5.5vw, 72px)", color: BORDEAUX, lineHeight: 1, letterSpacing: "-0.02em" }}>1M</span>
              <span style={{ fontFamily: "'Heebo', sans-serif", fontWeight: 300, fontSize: "clamp(20px, 2.8vw, 36px)", color: GOLD, lineHeight: 1 }}>+</span>
            </div>
            <span style={{ fontFamily: "'Heebo', sans-serif", fontWeight: 300, fontSize: "clamp(11px, 0.82vw, 13px)", color: "rgba(62,4,9,0.45)", letterSpacing: "0.18em", textTransform: "uppercase" }}>
              {isHe ? "לקוחות שמחו איתנו" : "Happy Guests"}
            </span>
          </div>

          {/* Divider */}
          <div style={{ width: "1px", height: "60px", background: GOLD_R + "0.2)" }} />

          {/* Stat 2 — Years */}
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "0.5rem", padding: "0 1.5rem" }}>
            <div style={{ display: "flex", alignItems: "baseline", gap: "2px" }}>
              <span style={{ fontFamily: "'Heebo', sans-serif", fontWeight: 900, fontSize: "clamp(38px, 5.5vw, 72px)", color: BORDEAUX, lineHeight: 1, letterSpacing: "-0.02em" }}>25</span>
              <span style={{ fontFamily: "'Heebo', sans-serif", fontWeight: 300, fontSize: "clamp(20px, 2.8vw, 36px)", color: GOLD, lineHeight: 1 }}>+</span>
            </div>
            <span style={{ fontFamily: "'Heebo', sans-serif", fontWeight: 300, fontSize: "clamp(11px, 0.82vw, 13px)", color: "rgba(62,4,9,0.45)", letterSpacing: "0.18em", textTransform: "uppercase" }}>
              {isHe ? "שנות מסורת ברזילאית" : "Years of Brazilian Tradition"}
            </span>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "0.5rem", padding: "0 1.5rem" }}>
            ...
            <div style={{ display: "flex", alignItems: "baseline", gap: "4px" }}>
              <span style={{ fontFamily: "'Heebo', sans-serif", fontWeight: 900, fontSize: "clamp(38px, 5.5vw, 72px)", color: BORDEAUX, lineHeight: 1, letterSpacing: "-0.02em" }}>4.3</span>
              <span style={{ fontFamily: "'Heebo', sans-serif", fontWeight: 300, fontSize: "clamp(20px, 2.8vw, 36px)", color: GOLD, lineHeight: 1 }}>★</span>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.45rem" }}>
              ...
              <span style={{ fontFamily: "'Heebo', sans-serif", fontWeight: 300, fontSize: "clamp(11px, 0.82vw, 13px)", color: "rgba(62,4,9,0.45)", letterSpacing: "0.12em", textTransform: "uppercase" }}>
                {isHe ? "5,123 ביקורות Google" : "5,123 Google Reviews"}
              </span>
            </div>
          </div>
        </div>
