 ...
 * Route: /gallery
 * Design: White background, gold accents, Bordeaux text
 * Uses the shared Navbar and Footer components
 */
...
export default function Gallery() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#ffffff" }}>
      ...
      <div style={{
        paddingTop: "100px",
        padding: "100px 6vw 2.5rem",
        maxWidth: "1300px",
        margin: "0 auto",
        direction: isHe ? "rtl" : "ltr",
      }}>
        <div style={{ display: "flex", alignItems: "center", gap: "0.7rem", marginBottom: "1.2rem", flexDirection: isHe ? "row-reverse" : "row" }}>
          <div style={{ width: "20px", height: "1px", background: GOLD }} />
          <span style={{
            fontFamily: "'Heebo', sans-serif", fontWeight: 700,
            fontSize: "0.65rem", letterSpacing: isHe ? "0.1em" : "0.44em",
        ...
        <h1 style={{
          ...
          {isHe ? (<>חוו את<br />החוויה</>) : (<>FEEL THE<br />EXPERIENCE</>)}
        </h1>
          ...
          {filtered.map((img, i) => (
            ...
            >
              ...
              <div style={{
                ...
                [isHe ? "right" : "left"]: "0.9rem",
              }}>
                <div style={{ display: "flex", alignItems: "center", gap: "0.4rem", flexDirection: isHe ? "row-reverse" : "row" }}>
                  <div style={{ width: "8px", height: "1px", background: GOLD }} />
                  <span style={{
                    fontFamily: "'Heebo', sans-serif", fontWeight: 700,
                    fontSize: "0.65rem", letterSpacing: isHe ? "0.06em" : "0.36em",
                    textTransform: "uppercase", color: GOLD,
                  }}>{isHe ? img.labelHe : img.labelEn}</span>
                </div>
              </div>
            </motion.div>
          ))}
