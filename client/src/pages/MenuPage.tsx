...
const MENU_DATA: MenuCategory[] = [
  {
    ...
    type: "rodizio",
    illustration: "https://d2xsxph8kpxj0f.cloudfront.net/310519663392712778/NSX3yZdWqRV4jGmQcXqBFP/logo-main_9422517b.webp",
    items: [],
    appetizers: [
  ...
  },
  {
    ...
    label: "Under 12",
    labelHe: "עד גיל 12",
    illustration: "https://d2xsxph8kpxj0f.cloudfront.net/310519663392712778/NSX3yZdWqRV4jGmQcXqBFP/under12-illustration-fixed_020d9ccf.webp",
    subtitle: "Kids Team",
    subtitleHe: "קידס טים",
  ...
  },
  {
    id: "lunch",
    label: "Lunch Set",
    labelHe: "עסקיות צהריים",
    subtitle: "Sunday–Saturday 12:00–15:00",
    subtitleHe: "ראשון–שבת 12:00–15:00",
    description: "Lunch sets include shared starters and your choice of a main course. Available every day 12:00–15:00.",
    descriptionHe: "עסקיות הצהריים כוללות מנות פתיחה משותפות ועיקרית לבחירתכם. בכל יום 12:00–15:00.",
    type: "deal",
                ...
                {category.tracks.map((track, ti) => (
                  <div key={ti} dir={isHe ? "rtl" : "ltr"} style={{
                    ...
                    <div style={{ marginBottom: "1.2rem" }}>
                      {/* Count badge — green for track 0, gold for track 1 */}
                      <div style={{
                        display: "inline-block",
                        border: `1px solid ${ti === 1 ? "rgba(254,223,0,0.55)" : "rgba(0,156,59,0.45)"}`,
                        borderRadius: "3px",
                        padding: "0.25rem 0.75rem",
                        marginBottom: "0.7rem",
                        background: ti === 1 ? "rgba(254,223,0,0.10)" : "rgba(0,156,59,0.06)",
                      }}>
                        <span style={{ fontFamily: "'Heebo', sans-serif", fontWeight: 800, fontSize: "clamp(16px, 1.3vw, 20px)", letterSpacing: "0.10em", color: ti === 1 ? "#FEDF00" : "#009C3B", textTransform: "uppercase" }}>
                    ...
                    {track.note && (
                      <div style={{
                        ...
                        <p style={{ fontFamily: "'Heebo', sans-serif", fontWeight: 400, fontSize: "clamp(15px, 1.1vw, 17px)", color: "rgba(62,4,9,0.70)", margin: 0, fontStyle: "italic", textAlign: isHe ? "right" : "left", direction: isHe ? "rtl" : "ltr" }}>
  ...
  return (
    <div
      style={{
        ...
        marginTop: sticky ? 0 : (isMobile ? "0.5rem" : "2.5rem"),
        zIndex: 40,
